...
export default async function Home() {
  ...
  return <>{homepage.map((homepageItem) => renderHomepage(homepageItem))}</>;
}
...
const renderHomepage = (homepage: THomepage) => {
  switch (homepage.section_type) {
    ...
    case 'solutions':
      return <SolutionsSection key={homepage.id} content={homepage} />;
    case 'certifications':
      return <CertificationSection key={homepage.id} content={homepage} />;
    case 'blog':
      return <BlogSection key={homepage.id} content={homepage} />;
    case 'contact':
